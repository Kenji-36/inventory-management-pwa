...
export function BottomNav() {
  ...
  return (
    <nav aria-label="モバイルナビゲーション" className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-xl border-t border-gray-200 safe-area-bottom">
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isActive && (
                <div className="w-4 h-0.5 bg-gray-800 rounded-full mt-0.5" aria-hidden="true" />
              )}
            </Link>
          );
        })}
